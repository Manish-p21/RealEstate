    ...
    <div className="relative w-full">
      ...
      >
        <div className="flex items-center max-w-4xl w-full mx-6 bg-white/15 backdrop-blur-xl rounded-2xl p-4 shadow-xl animate-slideUp">
          ...
          {/* Search Button */}
          <button className="px-6 py-3 bg-white text-gray-900 rounded-full font-semibold hover:bg-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl animate-pulse">
            Search
          </button>
        </div>
      </div>
