  ...
  return (
    <div className="w-full px-4 sm:px-0 py-12">
            ...
            <SwiperSlide key={index}>
              <div className="relative h-96 rounded-lg overflow-hidden animate-fadeIn">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <button className="mt-4 swiper-btn">View Details</button>
                </div>
              </div>
            </SwiperSlide>
          ))}
      ...
      <div className="bg-gradient-to-r from-gray-900 to-black py-12 px-4 sm:px-6 rounded-lg text-center mb-12 animate-slideUp">
        ...
        <button className="btn-primary px-8 py-3">Get Started Now</button>
      </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {suggestedCities.map((city) => (
                  <button
                    ...
                    className="p-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-300 text-sm"
                  >
                    {city}
                  </button>
                ))}
